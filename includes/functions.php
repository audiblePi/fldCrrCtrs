...
function shell_breadcrumb_lists() {
    ...
    if (!function_exists('shell_js')) {
        ...
        function shell_js() {
            ...
            wp_enqueue_script('jcorners', get_template_directory_uri() . '/js/jquery.corner.js', array('jquery'), '2.12', true);
        }
    ...
    function shell_widgets_init() {
        ...
        register_sidebar(array(
            ...
            'before_title' => '<div class="widget-title-home blue"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '',
            'after_widget' => ''
        ));
        ...
        register_sidebar(array(
            ...
            'before_title' => '<div class="widget-title-home yellow"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '',
            'after_widget' => ''
        ));
        ...
        register_sidebar(array(
            ...
            'before_title' => '<div class="widget-title-home green"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '',
            'after_widget' => ''
        ));
        register_sidebar(array(
            'name' => __('Bottom Home Left Widget', 'shell'),
            'description' => __('Welcome Area', 'shell'),
            'id' => 'bottom-home-left-widget',
        ...
        register_sidebar(array(
            'name' => __('Bottom Home Right Widget', 'shell'),
            'description' => __('News Widget Area', 'shell'),
            'id' => 'bottom-home-right-widget',
            'before_title' => '<div class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '',
            'after_widget' => ''
