...
function shell_theme_options_do_page() {
    ...
    <div class="wrap">
        <?php screen_icon();
        echo "<h2>" . get_current_theme() . __(' Theme Options', 'shell') . "</h2>"; ?>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top"><th scope="row"><?php _e('Featured Image', 'shell'); ?></th>
                    <td>
                        <input id="shell_theme_options[featured_image]" class="regular-text" type="text" name="shell_theme_options[featured_image]" value="<?php esc_attr_e($options['featured_image']); ?>" />
                        <label class="description" for="shell_theme_options[featured_image]"><?php _e('Enter your featured image', 'shell'); ?></label>
                    </td>
                </tr>
